...
| **Gemma 2 27b**                                                 | Very fast, follows presets well, handles complex tasks with concise prompts, somewhat maintains character, displays quirky behavior and humor                                           |
...
| **DeepSeek V3**                                                 | Similar to Sonnet and Gemini it is good for both roleplay and following advanced instructions.                                                                                          |
|                                                                 |                                                                                                                                                                                         |
...
| **3.5 Haiku**                                                   |                                                                                                                                                                                         |
|                                                                 |                                                                                                                                                                                         |
| <mark style="color:red;">**DEPRECIATED MODELS**</mark>          |                                                                                                                                                                                         |
| **WizardLM 2 7b (Turbo)**                                       | <p>Fast long role-player but doesn't follow format well.<br><em>(This model is currently being redirected to microsoft phi-4)</em></p>                                                  |
| **lzlv 70b**                                                    | _(This model is currently being redirected to Llama 3.3 70b Instruct)_                                                                                                                  |
| **Lunaris L3 8B**                                               | <p>Good for short fast basic roleplay<br><em>(Will be depreciated in January 22)</em></p>                                                                                               |
